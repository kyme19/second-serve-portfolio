      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1 space-y-6">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-blue-900">Food Donation Platform</h2>
          ...
          <div className="flex-1 relative">
            <div className="aspect-square max-w-md mx-auto bg-blue-100 rounded-2xl overflow-hidden relative">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center space-y-4">
                  ...
                  <div className="bg-white/90 py-3 px-6 rounded-lg">
                    <p className="text-blue-800 font-semibold">Platform Active</p>
                  </div>
                </div>
              </div>
